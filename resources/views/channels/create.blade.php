...
<div class="max-w-2xl mx-auto">
    <h1 class="text-3xl font-bold mb-6">إضافة قناة جديدة</h1>

    <form action="{{ route('channels.store') }}" method="POST" class="bg-gray-800 rounded-lg p-6 border border-gray-700">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="url" name="stream_url" class="w-full bg-gray-700 border border-gray-600 rounded px-4 py-2 text-white" placeholder="https://example.com/stream.m3u8" required>
